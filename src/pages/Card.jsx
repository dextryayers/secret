...
const cards = [
  {
    ...
    lines: [
      ...
      'bukan hari biasa bagi dunia,',
      'tapi bagi aku, itu hari dimana',
      'malaikat paling cantik lahir.',
      '',
      'Sejak saat itu, aku percaya',
      'bahwa Tuhan memang punya rencana',
      'indah untuk mempertemukan aku',
      'dengan kamu, Zahwa.',
      '',
      'Dulu aku gak pernah percaya',
      'sama yang namanya takdir,',
      'sampai akhirnya aku kenal kamu',
      'dan semuanya berubah. 💗',
      '',
      'Selamat ulang tahun,',
      'cinta. Terima kasih',
      'sudah lahir ke dunia ini,',
      'sudah menjadi alasan',
  ...
  },
  {
    ...
    lines: [
      'Kamu itu unik, Zahwa.',
      'Cara kamu bicara, cara kamu',
      'tersenyum, cara kamu melihat',
      'aku — semuanya terasa',
      'seperti rumah.',
      '',
      'Tempat aku pulang',
      ...
      '',
      'Aku suka semuanya dari kamu.',
      'Aku suka gimana kamu',
      'bikin aku nyaman,',
      'aku suka gimana kamu perhatian,',
      'aku suka semua tingkahmu. 🥰',
      '',
      'Gak ada satu hal pun',
      'dari dirimu yang tidak',
      'aku syukuri setiap harinya.',
      'Kamu sempurna di mata aku,',
  ...
  },
  {
    ...
    lines: [
      ...
      'tersenyum sendiri. 🥺',
      '',
      'Setiap detik bersama kamu,',
      'aku rasa berharga.',
      'Setiap pesan dari kamu,',
      'aku baca berulang kali.',
      'Setiap kali kamu bahagia,',
      'aku juga ikut bahagia.',
      '',
      'Aku pengen terus bikin kamu',
      'tersenyum, karena senyummu',
      'itu yang bikin hariku',
      'jauh lebih berarti.',
      'I love you, Zahwa. 💖',
    ],
  },
  {
    ...
    lines: [
      ...
      'aku sering bikin kamu',
      'kesal, kecewa, atau sedih.',
      '',
      'Aku sadar aku bukan',
      'pacar yang sempurna.',
      ...
      'Tapi percayalah,',
      'aku selalu berusaha',
      'jadi yang terbaik untuk kamu.',
      '',
      'Aku gak pernah punya',
      'niat buat menyakiti',
      'perasaan kamu, Zahwa.',
      ...
      'Aku janji akan terus',
      'belajar dan memperbaiki diri,',
      'biar bisa jadi',
      'pacar yang layak di sampingmu.',
      'Jangan capek sama aku ya,',
  ...
  },
  {
    ...
    lines: [
      ...
      'Semoga kamu selalu',
      'diberi kesehatan,',
      'dilindungi dari segala',
      'hal yang buruk,',
      'dan dikelilingi oleh',
      'orang-orang yang tulus',
      'menyayangimu.',
      '',
      'Semoga semua mimpi-mimpi',
      'indah kamu tercapai.',
      'Semoga kamu selalu',
      'dikelilingi kebahagiaan,',
      'dan semoga kamu',
      'gak pernah merasa sendiri.',
      '',
      'Dan satu lagi...',
      'semoga aku selalu',
      'pantas untuk tetap',
      ...
      'dan aku akan selalu',
      'berusaha buat ngebahagiain kamu,',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ fontSize: '13px', fontWeight: 700, color: '#e91e63', margin: '0 0 6px' }}>Untuk Zahwa 💗</p>
              <p style={{ fontSize: '11px', color: '#4a1a2c', lineHeight: 1.6, margin: '0', textAlign: 'center' }}>Makasih udah hadir.</p>
              <p style={{ fontSize: '11px', color: '#4a1a2c', lineHeight: 1.6, margin: '2px 0 0', textAlign: 'center' }}>I love you. 💖</p>
            </div>
            <div style={{
              position: 'absolute', inset: 0, backfaceVisibility: 'hidden',
              ...
              <p style={{ fontSize: '11px', color: '#4a1a2c', lineHeight: 1.6, margin: '0', textAlign: 'center' }}>Aku beruntung punya kamu.</p>
              <p style={{ fontSize: '11px', color: '#4a1a2c', lineHeight: 1.6, margin: '2px 0 0', textAlign: 'center' }}>Love you. 💗</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div style={st.floating}>
          {Array.from({ length: 8 }).map((_, i) => (
            <span key={i} style={{
              ...
              animation: `float ${5 + (i % 3)}s ease-in-out ${i * 0.6}s infinite`,
              pointerEvents: 'none',
            }}>
              {['💗', '✨', '🌸', '💕', '🌟', '💖', '🩷', '🥰'][i]}
            </span>
      ...
      <div style={st.ctr}>
        {!ready && !done && (
          <div style={st.wait}>
            ...
            <p style={st.waitT}>Yeay! kamu mauu~ 🥺💕</p>
          </div>
        )}
          ...
          <div style={st.final}>
            <div style={st.finalCard}>
              ...
              <p style={st.finalT}>
                ...
                <br />
                <span style={{ fontSize: '16px', color: '#e91e63' }}>I Love You More Than Anything 💖</span>
              </p>
